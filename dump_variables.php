<?php
// these line format the output as HTML commnets
// and call dump_arry repeatedly
...
// line string to represenset the array as a set
...
function dump_array($array) {
    ...
    if (is_array($array)) {
        ...
        if ($size) {
            $count = 0;
            $string .= "{ ";
            // add each element's key an value to the string
        ...
        // if it is not an array, just return itu
        return $array;
    }
}
